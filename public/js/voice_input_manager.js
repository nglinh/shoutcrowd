...
VoiceInputManager.prototype.restart = function (event) {
  event.preventDefault();
  this.emit("restart");
};

VoiceInputManager.prototype.keepPlaying = function (event) {
  event.preventDefault();
  this.emit("keepPlaying");
};

VoiceInputManager.prototype.bindButtonPress = function (selector, fn) {
